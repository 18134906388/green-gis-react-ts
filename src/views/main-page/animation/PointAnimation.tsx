...
import { Map, Point, PointAnimation, GCJ02, LatLngType } from '@src/library/green-gis-js/src/index';
let amap = null;
let map = null;
export default class PointAnimationComponent extends React.Component {
  componentDidMount() {
